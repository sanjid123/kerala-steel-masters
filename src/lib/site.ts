...
export const SITE = {
  ...
  googleBusinessProfile: "https://share.google/qYZqDvxhfdiLoBveA",
  socials: {
    google: "https://share.google/qYZqDvxhfdiLoBveA",
...
export const TESTIMONIALS: Testimonial[] = [
  ...
  { name: "Mariya Joseph", location: "Palakkad", work: "Restaurant SS Counters", rating: 5, avatar: a2,
  ...
  { name: "Shibu Varghese", location: "Perinthalmanna", work: "Bakery Display", rating: 5, avatar: a4,
  ...
  { name: "Ar. Faisal Rahman", location: "Kozhikode", work: "Architect", rating: 5, avatar: a6,
  ...
  { name: "Anwar Sadath", location: "Malappuram", work: "Wedding Stage", rating: 5, avatar: a7,
    quote: "They handled the entire steel structure for our wedding stage and decoration support. Strong, safe and on time." },
  { name: "Jiby Thomas", location: "Kollam", work: "Catering Counters", rating: 5, avatar: a8,
